...
export default function DomesticRating() {
  const [APIData, setAPIData] = useState([]);
  useEffect(() => {
    axios.get(`https://63856416beaa6458265e9646.mockapi.io/rating/`)
      .then((response) => {
  ...
  const onDelete = (id) => {
    axios.delete(`https://63856416beaa6458265e9646.mockapi.io/rating/${id}`)
    .then(() => {
        getData();
    })
  };
